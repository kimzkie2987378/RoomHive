...
<main class="hp-dashboard hp-dashboard--flush-top">
  ...
  <aside class="hp-sidebar">
    ...
    <a href="pendingtenants.php" class="hp-side-link hp-side-link-badged active">
    ...
    <div class="pt-list">
      ...
      <?php else: foreach ($pendingApplications as $app): ?>
        ...
        <div
            ...
            data-listing-photo="<?php echo h($app['cover_photo'] ?: 'images/listing-placeholder.jpg'); ?>"
            data-tenant-name="<?php echo h($app['tenant_name']); ?>"
            data-tenant-email="<?php echo h($app['tenant_email']); ?>"
            data-tenant-avatar="<?php echo h($app['tenant_avatar'] ?: 'images/default-avatar.png'); ?>"
        ...
        >
          ...
          <img
            ...
            src="<?php echo h($app['cover_photo'] ?: 'images/listing-placeholder.jpg'); ?>"
          ...
          <div class="pt-info">
            ...
            <div class="pt-tenant-row">
              <img
                ...
                src="<?php echo h($app['tenant_avatar'] ?: 'images/default-avatar.png'); ?>"
...
(function () {
    ...
    document.querySelectorAll('.pt-card').forEach(function (card) {
        ...
        if (acceptBtn) {
            acceptBtn.addEventListener('click', function (event) {
                ...
                handleDecision(bookingId, tenantName, buttons, card, 'accept-booking.php',
        ...
        if (rejectBtn) {
            rejectBtn.addEventListener('click', function (event) {
                event.stopPropagation();
                handleDecision(bookingId, tenantName, buttons, card, 'reject-booking.php',
    ...
    if (modalAcceptBtn) {
        modalAcceptBtn.addEventListener('click', function () {
            ...
            var card = activeCard;
            handleDecision(bookingId, tenantName, [modalAcceptBtn, modalRejectBtn], card, 'accept-booking.php',
    ...
    if (modalRejectBtn) {
        modalRejectBtn.addEventListener('click', function () {
            ...
            var tenantName = activeCard.getAttribute('data-tenant-name');
            var card = activeCard;
            handleDecision(bookingId, tenantName, [modalAcceptBtn, modalRejectBtn], card, 'reject-booking.php',
