...
<main class="bd-page">
    ...
    <a href="mybookings.php" class="bd-back-link">&#8592; Back to My Bookings</a>
    ...
    <div class="bd-layout">
            ...
            <div class="bd-card">
                ...
                <div class="bd-listing-row">
                    <img
                        ...
                        src="<?php echo h($booking['cover_photo'] ?: 'images/ListingPlaceholder.png'); ?>"
                        alt="<?php echo h($booking['listing_title']); ?>"
                    >
                    <div>
                        <a href="listing-detail.php?id=<?php echo h($booking['listing_id']); ?>" class="bd-listing-title">
        ...
        <aside class="bd-sidebar">
            ...
            <div class="bd-card bd-host-card">
                ...
                <a href="listing-detail.php?id=<?php echo h($booking['listing_id']); ?>" class="bd-btn bd-btn-outline">
                    View Listing
                </a>
            </div>
