...
<main class="hp-dashboard hp-dashboard--flush-top">
  ...
  <aside class="hp-sidebar">
    ...
    <a href="hostbookings.php" class="hp-side-link active">
  ...
  <div class="hp-content">
    ...
    <div class="hp-booking-list">
      ...
      <?php else: foreach ($filtered as $b):
        ...
        $imageSrc = $b['cover_photo'] ?: 'images/listing-placeholder.jpg';
      ?>
        ...
        <div class="hp-booking-right">
          ...
          <?php if ($b['status'] === 'pending'): ?>
            <div class="hp-booking-actions">
              <form method="POST" action="bookingaction.php" style="display:inline;">
