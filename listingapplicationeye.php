...
$navItems = [
    ...
    ['label' => 'Listings Application', 'icon' => 'clipboard',  'href' => 'listingapplication.php', 'active' => true],
...
$backLink = 'listingapplication.php?' . http_build_query([
    'filter' => $filter,
    'page'   => $page,
    'id'     => $listingId,
]);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'], $_POST['id'])) {
    ...
    if (in_array($action, ['approve', 'reject'], true)) {
        ...
        header('Location: listingapplicationeye.php?' . http_build_query([
            'filter' => $filter,
            'page'   => $page,
            'id'     => $targetId,
        ]));
...
if (!$listing) {
    header('Location: listingapplication.php');
    exit();
}
                ...
                <div class="eye-panel">
                    ...
                    <?php if ($listing['status'] === 'pending'): ?>
                        <div class="detail-actions">
                            <form method="POST" action="<?= htmlspecialchars('listingapplicationeye.php?' . http_build_query(['filter' => $filter, 'page' => $page, 'id' => $listing['id']])) ?>" style="display:inline;">
