...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (
        ...
        /*
         * For now, the form is only being validated.
         *
         * Later, you can connect this section to MySQL
         * or an email service to store/send messages.
         */
...
<section class="contacts-hero">
    ...
    <div class="contacts-hero-image">
        ...
        <img
            src="images/WholeLivingRoom-Contacts.png"
    ...
    <div class="contacts-information">
        ...
        <div class="contacts-info-item">
            ...
            <div class="contacts-info-icon">
                ...
                <img
                    src="images/AddressIcon-Contacts.png"
                    alt="Address"
                >
        ...
        <div class="contacts-info-item">
            ...
            <div class="contacts-info-icon">
                ...
                <img
                    src="images/SocialMediaIcon-Contacts.png"
                    alt="Social Media"
                >
...
<section class="contacts-need-help">
    ...
    <div class="contacts-help-image">
        ...
        <img
            src="images/HeadsetIcon-Contacts.png"
            alt="Need help"
        >
...
<section class="contacts-support">
    ...
    <div class="contacts-support-icon">
        ...
        <img
            src="images/StillHaveQuestionsIcon-Contacts.png"
            alt="Contact support"
        >
